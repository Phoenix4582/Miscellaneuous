...
ERROR2 = "Item not found in to do list! Please try again."
todo_list = ['Meditate']
...
if __name__ == '__main__':
    speaker, recognizer = initialize_base()
    ...
    assistant = GenericAssistant('base.json', intent_methods=mappings)
    assistant.train_model()

    while True:
        try:
            message = vocal_to_text(recognizer)
